  ...
  return (
    <div className="relative min-h-screen overflow-hidden pt-20 pb-32">
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute right-1/4 bottom-1/4 h-96 w-96 rounded-full bg-rose/5 blur-3xl"></div>
      </div>
      ...
      <div className="container relative z-10 px-4">
        ...
        >
          <motion.div variants={itemVariants}>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-ivory mb-6">
              <GradientText
                colors={["#3d5a80", "#b76e79", "#e0d5c0", "#3d5a80"]}
                animationSpeed={12}
                showBorder={false}
                className="inline-block"
              >
                {t("templates.templateDetails.aiChatbot.title")}
              </GradientText>
            </h1>
            ...
            <ScrollReveal
              ...
              blurStrength={4}
            >
              {t("templates.templateDetails.aiChatbot.description")}
            </ScrollReveal>
            ...
            <div className="bg-charcoal/40 backdrop-blur-sm border border-sapphire/10 rounded-xl p-8 mb-10">
              ...
              <ul className="space-y-4">
                {(t("templates.templateDetails.aiChatbot.features") as unknown as string[]).map((feature, index) => (
            ...
            <Link 
              href="#"
              className="inline-flex items-center justify-center h-12 px-8 font-medium transition-colors border-2 border-sapphire text-ivory hover:bg-sapphire/10 rounded-full btn-hover-slide"
            >
          ...
          <motion.div variants={itemVariants}>
            <div className="relative h-96 rounded-xl overflow-hidden mb-10 bg-gradient-to-tr from-sapphire/20 to-beige/20 border border-sapphire/10">
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-ivory/40 text-lg">Template Preview</span>
              </div>
            </div>
            
            <div className="bg-charcoal/40 backdrop-blur-sm border border-sapphire/10 rounded-xl p-8">
              <h2 className="text-2xl font-bold text-ivory mb-4">
                {t("templates.howToUse")}
              </h2>
              
              <p className="text-ivory/70 mb-8">
                {t("templates.templateDetails.aiChatbot.usage")}
              </p>
              
              <ol className="space-y-6">
                {(t("templates.templateDetails.aiChatbot.steps") as unknown as string[]).map((step, index) => (
                  <li key={index} className="flex group">
                    <div className="flex-shrink-0 h-8 w-8 bg-gradient-to-r from-sapphire to-beige rounded-full flex items-center justify-center mr-4 transition-transform group-hover:scale-110">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-ivory mb-6">
            {t("templates.needCustomSolution")}
          </h2>
          ...
          <ScrollReveal
            ...
            blurStrength={4}
          >
            {t("templates.templateDetails.aiChatbot.customSolution")}
          </ScrollReveal>
