...
import { ArrowRight, ChevronDown, MousePointer } from "lucide-react"
  ...
  return (
    <section className="relative min-h-screen overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute left-0 top-0 h-full w-full bg-gradient-to-br from-charcoal via-charcoal to-charcoal/95"></div>
        ...
        >
          <div className="floating-element-slow glass-effect h-full w-full">
            ...
            <div className="absolute left-3 top-3 flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-ivory/80">Web Design</span>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="floating-element glass-effect h-full w-full">
            ...
            <div className="absolute left-3 top-3 flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-ivory/80">E-commerce</span>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="floating-element-fast glass-effect h-full w-full">
            ...
            <div className="absolute left-3 top-3 flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-ivory/80">Portfolio</span>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="floating-element glass-effect h-full w-full">
            ...
            <div className="absolute left-3 top-3 flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-ivory/80">Business</span>
            </div>
          </div>
        </motion.div>
      </div>
      ...
      >
        <motion.div className="text-center">
          <motion.div className="relative mb-6 inline-block" variants={itemVariants}>
            <motion.div
          ...
          <motion.p className="mx-auto mt-6 max-w-2xl text-lg text-ivory/70 md:text-xl" variants={itemVariants}>
            We create sophisticated, elegant websites that drive business growth and optimize your online presence.
            Experience luxury digital solutions tailored to your brand.
          </motion.p>
