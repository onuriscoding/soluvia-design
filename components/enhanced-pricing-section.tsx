      ...
      <div className="container relative z-10">
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-3">
          {pricingPlans.map((plan, index) => (
            <motion.div
              ...
              } bg-charcoal/50 backdrop-blur-sm transition-all duration-300 hover:shadow-lg hover:shadow-rose/5`}
            >
              {plan.popular && (
              ...
              <div className="p-8">
                ...
                <div className="mt-8">
                  <Button
                    ...
                    className={`w-full ${
                      plan.popular
                        ? "bg-gradient-to-r from-rose to-sapphire hover:shadow-lg hover:shadow-rose/20"
                        : "bg-charcoal/70 border border-ivory/10 hover:bg-charcoal/90 hover:border-rose/30"
                    }`}
                  >
                    <Link href="/contact">
        ...
        >
          <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
            ...
            <Button asChild className="bg-gradient-to-r from-rose to-sapphire hover:shadow-lg hover:shadow-rose/20">
              <Link href="/contact">
